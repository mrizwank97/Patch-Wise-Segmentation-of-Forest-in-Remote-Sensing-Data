...
def build_callbacks():
    checkpointer = ModelCheckpoint(filepath="../models/ben_data_vgg_s1_s2.h5", monitor='val_f1', verbose=1, save_best_only=True, save_weights_only=False, mode='max')
    ...
    csv = keras.callbacks.CSVLogger('../logs/ben_data_vgg_s1_s2.csv', separator=',')
