...
def build_callbacks():
    checkpointer = ModelCheckpoint(filepath="../models/ben_data_vgg_s1_moa.h5", monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=False, mode='max')
    ...
    csv = keras.callbacks.CSVLogger('../logs/ben_data_vgg_s1_moa.csv', separator=',')
